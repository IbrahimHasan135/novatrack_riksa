                    ...
                    <div class="field span-2">
                        ...
                        <div class="assign-grid">
                            <?php foreach (($users ?? []) as $assignUser): ?>
                                <label>
                                    <input type="checkbox" name="assigned_user_ids[]" value="<?= (int)$assignUser['id']; ?>" <?= in_array((int)$assignUser['id'], array_map('intval', $assignedIds), true) ? 'checked' : ''; ?>>
                                    <span><?= htmlspecialchars($assignUser['full_name'] ?: $assignUser['username']); ?></span>
                                    <small><?= htmlspecialchars($assignUser['role']); ?></small>
                                </label>
                            <?php endforeach; ?>
                        </div>
                    </div>
